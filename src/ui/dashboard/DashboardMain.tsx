...
interface DashboardMainProps {
  ...
  topSources: PanoramaSourceChart[];
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Line
                  ...
                  filter={
                    theme === DASHBOARD_THEME.DARK ? "url(#trendGlow)" : undefined
                  }
                />
                {reachPeak ? (
                  <ReferenceDot
            ...
            <>
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  ...
                  >
                    {formatNumber(
                      topPages.reduce((sum, item) => sum + item.vistas, 0),
                    )}{" "}
                    vistas
                  </span>
                </div>
        ...
        <div className="grid gap-4">
          ...
          >
            ...
            {topSources.length ? (
              <div className="mt-3 h-44">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={topSources} layout="vertical" margin={{ left: 4, right: 16 }}>
                    <defs>
                      <linearGradient id="sourceFill" x1="0" y1="0" x2="1" y2="0">
                        <stop
                          offset="0%"
                          stopColor="#22c55e"
                          stopOpacity={0.9}
                    ...
                    <Tooltip
                      ...
                      formatter={(value, _name, props) => {
                        const record = props.payload as PanoramaSourceChart | undefined;
                        return [formatNumber(Number(value ?? 0)), record?.fuente ?? ""];
                      }}
                    />
                    <Bar dataKey="usuarios" fill="url(#sourceFill)" radius={[6, 10, 10, 6]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            ) : (
          ...
          >
            ...
            {daySeries.length ? (
              <div className="mt-3 h-44">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={daySeries} margin={{ left: 0, right: 10, top: 10, bottom: 0 }}>
                    <defs>
